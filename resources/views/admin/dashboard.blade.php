...
<div class="admin-stats">
    <div class="stat-card">
        ...
        <div class="stat-card-content">
            ...
            <div class="stat-card-label">{{ __('News Articles') }}</div>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-card-content">
            ...
            <div class="stat-card-label">{{ __('Comments') }}</div>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-card-content">
            ...
            <div class="stat-card-label">{{ __('Messages') }}</div>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-card-content">
            ...
            <div class="stat-card-label">{{ __('Users') }}</div>
        </div>
    </div>
</div>
...
<div class="admin-grid">
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <h2><i class="fas fa-clock"></i> {{ __('Pending Comments') }}</h2>
            <a href="{{ route('admin.news-comments.index') }}" class="btn btn-sm btn-secondary">{{ __('View all') }}</a>
        </div>
        <div class="admin-card-body">
            @php $pendingCommentsList = \App\Models\NewsComment::where('is_approved', false)->with(['user', 'newsItem'])->latest()->take(5)->get(); @endphp
            @forelse($pendingCommentsList as $comment)
                <div class="activity-item">
                    ...
                    <div class="activity-content">
                        <p><strong>{{ $comment->user?->username ?? $comment->user?->name ?? 'Guest' }}</strong> {{ __('commented on') }} <a href="{{ route('news.show', $comment->newsItem) }}">{{ Str::limit($comment->newsItem->title, 30) }}</a></p>
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <h2><i class="fas fa-envelope"></i> {{ __('Recent Messages') }}</h2>
            <a href="{{ route('admin.contact.index') }}" class="btn btn-sm btn-secondary">{{ __('View all') }}</a>
        </div>
        <div class="admin-card-body">
...
<div class="admin-grid" style="margin-top: 1.5rem;">
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <h2><i class="fas fa-history"></i> {{ __('Recent Activity') }}</h2>
            <a href="{{ route('admin.activity-logs.index') }}" class="btn btn-sm btn-secondary">{{ __('View all') }}</a>
        </div>
        <div class="admin-card-body">
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <h2><i class="far fa-newspaper"></i> {{ __('Latest News') }}</h2>
            <a href="{{ route('admin.news.index') }}" class="btn btn-sm btn-secondary">{{ __('View all') }}</a>
        </div>
        <div class="admin-card-body">
            @php $latestNews = \App\Models\NewsItem::with('tags')->latest()->take(5)->get(); @endphp
            @forelse($latestNews as $news)
                <div class="activity-item">
                    ...
                    <a href="{{ route('admin.news.edit', $news) }}" class="activity-action" title="{{ __('Edit') }}">
...
<div class="admin-grid admin-grid--thirds" style="margin-top: 1.5rem;">
    ...
    <div class="admin-card admin-card--compact">
        <div class="admin-card-header">
            <h2><i class="fas fa-tags"></i> {{ __('Popular Tags') }}</h2>
        </div>
        <div class="admin-card-body">
            @php
            ...
            @if($popularTags->count() > 0)
                <div class="tag-cloud">
                    @foreach($popularTags as $tag)
                        <a href="{{ route('admin.tags.edit', $tag) }}" class="tag-cloud-item" title="{{ $tag->news_items_count }} {{ __('articles') }}">
    ...
    <div class="admin-card admin-card--compact">
        <div class="admin-card-header">
            <h2><i class="fas fa-user-clock"></i> {{ __('Recent Users') }}</h2>
        </div>
        <div class="admin-card-body">
    ...
    <div class="admin-card admin-card--compact">
        <div class="admin-card-header">
            <h2><i class="fas fa-server"></i> {{ __('System Info') }}</h2>
        </div>
        <div class="admin-card-body">
            <div class="system-info-list">
                ...
                <div class="system-info-item">
                    <span class="system-info-label"><i class="fas fa-database"></i> {{ __('Database') }}</span>
                    <span class="system-info-value">{{ ucfirst(config('database.default')) }}</span>
                </div>
                <div class="system-info-item">
                    <span class="system-info-label"><i class="fas fa-clock"></i> {{ __('Server Time') }}</span>
                    <span class="system-info-value">{{ now()->format('H:i') }}</span>
                </div>
                <div class="system-info-item">
                    <span class="system-info-label"><i class="fas fa-hdd"></i> {{ __('Storage') }}</span>
...
<div class="content-stats-bar" style="margin-top: 1.5rem;">
    <div class="content-stat">
        ...
        <div class="content-stat-info">
            ...
            <span class="content-stat-label">{{ __('FAQ Categories') }}</span>
        </div>
    </div>
    <div class="content-stat">
        ...
        <div class="content-stat-info">
            ...
            <span class="content-stat-label">{{ __('FAQ Items') }}</span>
        </div>
    </div>
    <div class="content-stat">
        <i class="fas fa-tags"></i>
        <div class="content-stat-info">
            ...
            <span class="content-stat-label">{{ __('Tags') }}</span>
        </div>
    </div>
    <div class="content-stat">
        ...
        <div class="content-stat-info">
            ...
            <span class="content-stat-label">{{ __('Pending Review') }}</span>
        </div>
    </div>
    <div class="content-stat">
        ...
        <div class="content-stat-info">
            ...
            <span class="content-stat-label">{{ __('Unread Messages') }}</span>
        </div>
    </div>
</div>
@endsection
