    ...
    <div class="container">
        <div class="error-content">
            ...
            <div class="error-actions">
                ...
                <a href="{{ route('projects') }}" class="btn btn-secondary"><i class="fas fa-folder"></i> Bekijk Projecten</a>
            </div>
            <div class="error-suggestions">
                <h3 data-translate="error_404_suggestions">Misschien zoek je:</h3>
                <ul>
                    <li><a href="{{ route('dev-life') }}"><i class="fas fa-code"></i> Developer Life</a></li>
                    <li><a href="{{ route('games') }}"><i class="fas fa-gamepad"></i> Gaming Stats</a></li>
                    <li><a href="{{ route('contact') }}" data-translate="nav_contact"><i class="fas fa-envelope"></i> Contact</a></li>
                </ul>
            </div>
        </div>
    </div>
